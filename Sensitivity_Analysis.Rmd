...
x1 = cbind.data.frame(min_temp_coeff, min_temp_coeff2, precip_coeff, precip_coeff2, intercept, min_temp, precip)
...
x2 = cbind.data.frame(min_temp_coeff, min_temp_coeff2, precip_coeff, precip_coeff2, intercept, min_temp, precip)

sens_results_sobol2 = sobol2007(model = NULL, x1, x2, nboot = 500)
...
# The sens_almond_sobol2 is giving the error: in d[, 1]: is.atomic(x) is not TRUE
